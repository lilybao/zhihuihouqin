...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wxcc3718c83beeb9d6";//微信开发平台应用id   （zhihuihouqin----wx821756ccd73c95fd）需要改
	public static String APP_SECRET ="39bd42460d430e33112e1a86c7694e8b";//应用对应的凭证（zhihuihouqin----965184644903278977087e877b42e5df）
	//应用对应的密钥
	public static String APP_KEY = "yNbJCZNImHBatCSQwOe326u3K58y5Rei";//9HfbxI2Guv0NaJdnIoFDWh1IMD0xJfkt
	public static String PARTNER = "1483120672";// 财付通商户号(微信支付分配的商户号) （1265257801）需要改
	public static String PARTNER_KEY = "yNbJCZNImHBatCSQwOe326u3K58y5Rei";//商户号对应的密钥  需要改
